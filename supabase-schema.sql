...
--
-- Exported schema mirror of the Pokémon Draft League database. It reflects the
-- current state of every table, index, and function, consistent with the
-- migrations under supabase/migrations/ (the initial schema plus the invites
-- and draftboard additions). Some objects may have been created via the
-- Supabase dashboard rather than a migration; this file documents them all.
...
-- (Mirrors supabase/migrations/20250915_invites_and_draftboard.sql)
